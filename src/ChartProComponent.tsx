...
const ChartProComponent: Component<ChartProComponentProps> = props => {
  ...
  let loading = false
  const [getBarSpace] = createSignal()
  ...
  const [sCreateIndicator] = createSignal()
